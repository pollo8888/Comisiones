	...
	<div class="content">
		<div class="page-inner">
			<div class="page-header">
				<h4 class="page-title">Subir excel DM-01</h4>
									...
									<div class="col-md-12 mt-4">
										...
										<div class="card">
											<div class="card-body">
												...
												<form action="CRUD/contextos/subirexcel/code_DM-01.php" method="POST" enctype="multipart/form-data">
                                                    <span>IMCob_NumDenom</span>
