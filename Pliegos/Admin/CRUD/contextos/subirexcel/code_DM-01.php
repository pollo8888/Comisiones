        ...
        if (in_array($file_ext, $allowed_ext)) {
            ...
            foreach ($data as $row) {
                if ($count > 0) {
                    ...
                    $Poblacionn[] = str_replace(",", "", $row['1']);
                    $NumeroCo[] = str_replace(",", "", $row['2']);
                    $PoblacionnF[] = str_replace(",", "", $row['5']);
                    $NumeroCoG[] = str_replace(",", "", $row['6']);
    ...
    if ($cadena3 == "IMCob_NumDenom") {
        ...
        if (in_array($file_ext1, $allowed_ext1)) {
            ...
            foreach ($dataaa as $rows) {
                if ($counts > 0) {
                    $Det_Diabetes_45_59_M823 =  $rows['51'];
                    $Prev_Diabetes_PobM_45_5982323 = $rows['50'];
                    

                    $Det_Diabetes_45_59_M8[] = str_replace(",", "", $rows['51']);
                    $Prev_Diabetes_PobM_45_598[] = str_replace(",", "", $rows['50']);
                } else {
                    $counts = "1";
                }
            }
            ...
            foreach ($dataaa1 as $rows1) {
                if ($counts1 > 0) {
                    $Det_Diabetes_45_59_H9232 =  $rows1['31'];
                    $Prev_Diabetes_PobH_45_5992323 = $rows1['30'];


                    $Det_Diabetes_45_59_H9[] = str_replace(",", "", $rows1['31']);
                    $Prev_Diabetes_PobH_45_599[] = str_replace(",", "", $rows1['30']);
            ...
            foreach ($dataaa2 as $rows2) {
                if ($counts2 > 0) {
                    $Det_Diabetes_60_10232 =  $rows2['30'];
                    $Prev_Diabetes_Pob_60_1023= $rows2['29'];

                    
                    $Det_Diabetes_60_10[] = str_replace(",", "", $rows2['30']);
                    $Prev_Diabetes_Pob_60_10[] = str_replace(",", "", $rows2['29']);
                } else {
                    $counts2 = "1";
                }
            }
...
if ($cadena2 == "CP03D" && $cadena3 == "IMCob_NumDenom") {
    ...
    $nombreDelDocumento = "Estadísticas.xlsx";
